...
from rl.networks.policy import Policy
...
class CADRL(Policy):
    ...
    def set_common_parameters(self, config):
        self.gamma = config.policy.rl_gamme
        self.kinematics = config.policy.action_space_kinematics
        self.sampling = config.policy.action_space_sampling
