...
class CrowdSimAlpha(CrowdSim):
    ...
    def __init__(self):
        ...
        """
        super(CrowdSimAlpha, self).__init__()
    ...
    def set_robot(self, robot):
        ...
        d['robot_state'] = gym.spaces.Box(low=-np.inf, high=np.inf, shape=(1, 9), dtype=np.float32)
    ...
    def generate_ob(self, reset, sort=False):
        ...
        ob['robot_state'].append(np.array([self.robot.vx, self.robot.vy]))
        ...
        ob['human_state'][:self.human_num][self.human_visibility] = (np.array([]))
