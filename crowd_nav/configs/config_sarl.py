...
class ConfigSARL(object):
    ...
    policy = BaseConfig()
    policy.rl_gamme = 0.9
    policy.action_space_kinematics = 'holonomic'
    policy.action_space_sampling = 'exponential'
    policy.action_space_speed_samples = 5
    policy.action_space_rotation_samples = 16
    policy.action_space_query_env = True
    policy.cadrl_mlp_dims = '150, 100, 100, 1'
